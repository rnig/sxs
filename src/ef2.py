        ...
        if inside_tag:
            if data_read == '>':
                ...
                if inside_closing_tag:
                    ...
                    if end_data_index > 0:
                        ####################################################
                        # Op  basis   van  nested_level  kan   je  een
                        # headerlijn definiëren  terwijl de  XML wordt
                        # afgelezen.  Telkens een  tag wordt afgewerkt
                        # moet  de  tag  zelf in  de  header  verwerkt
                        # worden.
                        # Als  we  buiten  de  tag zitten  dus  in  de
                        # feitelijke data, moet de  data in de datarij
                        # worden opgeslagen onder de juiste header.
                        # Als een  tag (meerdere) geneste tags  en dus
                        # sub-levels  heeft maar  zonder zelf  data te
                        # bevatten  moeten   de  sub-levels   via  een
                        # verbindingsteken aan hun parent-level worden
                        # gekleefd in de header, bijv:
                        #
                        ...
                        #
                        #
                        # Alternatief  zou je  in  een rekenblad  alle
                        # sublevels onder een parent-headerlijn kunnen
                        # grouperen, bijv:
                        #
                        # P1           |       | P3
